...
namespace Vision.Service
{
    public class ActivityLogger
    {
        ...
        {
            folderPath = AppPath.UsageLogsFolder;
            autoRunFilePath = AppPath.autorunFilePath;
        ...
        {
            RegistryKey key = Registry.CurrentUser.OpenSubKey(AppPath.AUTORUN_REGPATH);

            bool isAutoRun = key.GetValue(AppPath.AUTORUN_REGKEY) != null ? true : false;
        ...
        public void OnTimer()
        {
            ...
            uint currProcessId = WindowManager.GetForegroundProcessId(handle);
        ...
        private void UpdateTimeEntry(Process proc)
        {
            ...
            try
            {
                ...
                if (!found)
                {
                    string newProcessName = WindowManager.GetActiveProcessName(proc);
                    string newProgramName = WindowManager.GetActiveProgramName(proc);
